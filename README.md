...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dnqax-o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dnqax-o.containers.anotherwebservice.com/
...
```
git clone git@github.com:Azrogue/container-dnqax-o.git
cd container-dnqax-o
```
...
```
docker attach container-dnqax-o
```
